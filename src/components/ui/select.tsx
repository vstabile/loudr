...
const SelectValue = (props: any) => (
  <SelectValuePrimitive {...props} class={`text-gray-600 ${props.class || ""}`}>
    {props.children}
...
const SelectTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <SelectPrimitive.Trigger
      class={cn(
        "flex h-10 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm placeholder:text-placeholder-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...others}
    >
  ...
  "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70",
  {
    variants: {
      variant: {
        ...
        description: "font-normal text-placeholder-foreground",
